...
## classical Bell DAG, finds dist compatibility
...
def main():
    ...
    def P_AB_giv_XY(A,B, X, Y):
        ...
        # return P_ABXY/P_AB
        return P_AB_giv_XY_dict[(A,B,X,Y)]



    internal_gurobi_expr = sum([W[i]*generate_top(i) for i in range(16)])
    
    # symbolic mixture of extremal points
    ...
    print("\nIs the distribution compatible with the Bell scenario?", is_compatible)
